...
<!--cards and widgets above here-->
        <footer class="footer">
            <div class="container-fluid">
                ...
                <div class="copyright pull-right">
                    &copy; <script>document.write(new Date().getFullYear())</script>,Traido &nbsp;<i class="ti-heart heart"></i> &nbsp;a ti por <a href="https://acapulco.tecnm.mx/">CEI</a>
                </div>
            </div>
        </footer>
	...
	<script type="text/javascript">
    	$(document).ready(function(){
        	...
        	$.notify({
            	icon: 'ti-gift',
            	message: "Bienvenido  a <b> Sistema de Administracion Escolar </b> - Un hermoso software para administrar su escuela."
